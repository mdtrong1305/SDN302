...
export default function Header({
    ...
    return (
        <header className={`sticky top-0 z-50 w-full bg-[#F6F3F9] shadow-sm transition-transform duration-300 animate__animated animate__fadeInDown ${isVisible ? "translate-y-0" : "-translate-y-full"
            }`}>
            <div className="mx-auto flex max-w-[85%] items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
                ...
                <a href="/" className="flex items-center gap-0 group" aria-label="Mievoh Homepage">
                    <img
                        ...
                        alt="Mievoh Logo"
                        className="h-12 w-12 rounded-full object-cover group-hover:scale-105 transition-transform duration-200"
                    />
                    <img
                        src="/images/mievoh_text.png"
                        alt="mievoh"
                        className="h-48 w-auto object-contain my-[-4.6rem] ml-[-1.5rem] transition-transform duration-200 group-hover:scale-[1.02]"
                    />
                </a>
                ...
                <nav className="hidden items-center gap-8 md:flex">
                    {navItems.map((item) => {
                        ...
                        const isActive =
                            ...
                            (item.href === "/movies" && (location.pathname === "/" || location.pathname === "")) ||
                        ...
                        return (
                            ...
                            >
                                {item.label}
                                {isActive && (
                                    <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#6D28D9] rounded-full animate-slide-in" />
                                )}
                            </a>
                        );
                    })}
                            ...
                            <div className="relative">
                                ...
                                {userMenuOpen && (
                                    <div className="absolute right-0 mt-2 w-64 rounded-xl border border-gray-100 bg-white p-2 shadow-xl z-50">
                                        ...
                                        <a href="/profile" className="block rounded-lg px-3 py-2 text-sm text-gray-700 hover:bg-violet-50 hover:text-violet-700 transition-colors">Profile</a>
                                        <Button
                                            variant="danger"
            ...
            {/* Mobile nav dropdown */}
            {isOpen && (
                <div className="absolute right-6 top-20 w-64 rounded-xl border border-gray-100 bg-white p-4 shadow-xl z-50 md:hidden animate-in fade-in slide-in-from-top-2 duration-200">
