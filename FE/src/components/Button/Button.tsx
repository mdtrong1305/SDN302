...
export default function Button({
    ...
    const variantStyles = {
        ...
        "outline-purple": "bg-transparent text-[#6D28D9] border border-transparent hover:bg-[radial-gradient(circle_at_center,_#9370DB_0%,_#7B68EE_100%)] hover:text-white hover:shadow-[0_8px_20px_-6px_rgba(109,40,217,0.4)] hover:scale-[1.04] active:scale-[0.96] disabled:opacity-55 rounded-full",
