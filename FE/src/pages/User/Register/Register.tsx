...
import { loginUser, clearError } from '../Login/slice.ts';
...
export default function Register() {
    ...
    // Switch state triggers local sliding transition (starts as active right panel)
                    ...
                    <div className="overlay">
                        ...
                        <div className="overlay-panel overlay-left">
                            ...
                            <h2 className="text-3xl md:text-4xl font-black mb-4 flex items-center gap-1.5 text-white text-center">
                                Already have an account? <Sparkles className="h-5 w-5 text-amber-300 animate-pulse" />
                            </h2>
                            <p className="text-base md:text-lg text-violet-100 max-w-[360px] mb-10 leading-relaxed text-center">
                                Sign in now to keep booking blockbuster tickets and get exclusive deals from Mievoh!
                            </p>
